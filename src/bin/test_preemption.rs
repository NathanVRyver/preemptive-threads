...
use preemptive_mlthreading_rust::{scheduler::SCHEDULER, preemption::Preemption, thread::ThreadContext};
...
fn main() {
    ...
    unsafe {
        ...
        scheduler.spawn_thread(&mut STACK1, infinite_loop_thread1, 1).unwrap();
        scheduler.spawn_thread(&mut STACK2, infinite_loop_thread2, 1).unwrap();
